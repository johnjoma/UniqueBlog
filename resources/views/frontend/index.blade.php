...
<title>Unique</title>
<link rel="icon" href="{{url('public/frontend/img/favicon.png" type="image/png')}}">
...
<header id="header_wrapper">
  <div class="container">
    <div class="header_box">
      <div class="logo"><a href="#"><img src="{{url('public/frontend/img/logo.png')}}" alt="logo"></a></div>
      ...
      <div class="hero_section">
        <div class="row">
          ...
          <div class="col-lg-7 col-sm-5">
			<img src="{{url('public/frontend/img/main_device_image.png')}}" class="zoomIn wow animated" alt="" />
		  </div>
        </div>
      </div>
    </div>
...
<div class="inner_wrapper">
  <div class="container">
	...
	<div class="row">
      <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right"><img src="{{url('public/frontend/img/about-img.jpg')}}" class="img-circle delay-03s animated wow zoomIn" alt=""></div>
    ...
    <div class="team_section clearfix">
      <div class="team_area">
        <div class="team_box wow fadeInDown delay-03s">
          ...
          <img src="{{url('public/frontend/img/team_pic1.jpg')}}" alt="">
          <ul>
      ...
      <div class="team_area">
        <div class="team_box  wow fadeInDown delay-06s">
          <div class="team_box_shadow"><a href="javascript:void(0)"></a></div>
          <img src="{{url('public/frontend/img/team_pic2.jpg')}}" alt="">
          <ul>
            <li><a href="javascript:void(0)" class="fa fa-twitter"></a></li>
            <li><a href="javascript:void(0)" class="fa fa-facebook"></a></li>
            <li><a href="javascript:void(0)" class="fa fa-pinterest"></a></li>
      ...
      <div class="team_area">
        <div class="team_box wow fadeInDown delay-09s">
          <div class="team_box_shadow"><a href="javascript:void(0)"></a></div>
          <img src="{{url('public/frontend/img/team_pic3.jpg')}}" alt="">
          <ul>
            <li><a href="javascript:void(0)" class="fa fa-twitter"></a></li>
            <li><a href="javascript:void(0)" class="fa fa-facebook"></a></li>
            <li><a href="javascript:void(0)" class="fa fa-pinterest"></a></li>
